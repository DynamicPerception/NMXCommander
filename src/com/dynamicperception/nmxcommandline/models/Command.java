...
public class Command {
    ...
    public class DefaultExecute implements ExecuteStructure {
        ...
        private <T> T executeThis(int subAddr, String dataStr, boolean hasData) {
            ...
            // Notify if data is attached to a command that does not take
            // additional data
    ...
    public static class Names {
        ...
        public static class General {
            ...
            public static final String SET_LOAD_POS                      = "g.setLoadPos";
            public static final String SET_LOAD_START_STOP               = "g.setLoadStartStop";
            public static final String SET_LOAD_END                      = "g.setLoadEnd";
            ...
            public static final String GET_LOAD_POS                      = "g.getLoadPos";
            public static final String GET_LOAD_START_STOP               = "g.getLoadStartStop";
            public static final String GET_LOAD_END                      = "g.getLoadEnd";
            public static final String IS_GRAFFIK                        = "g.isGraffik";
            public static final String GET_ADV_RUN_STATUS                = "g.getAdvRunStatus";
        ...
        public static class Motor {
            ...
            public static final String SET_END         = "m.setEnd";
            ...
            public static final String GET_MAX_SPEED   = "m.getMaxSpeed";
            ...
            public static final String IS_LEGACY_VALID = "m.isLegacyValid";
            public static final String GET_UNITS       = "m.getUnits";
            public static final String GET_GBOX_RATIO  = "m.getGboxRatio";
            public static final String GET_PLAT_RATIO  = "m.getPlatRatio";
        ...
        public static class Camera {
            ...
            public static final String SET_INTERVALOMETER_MODE = "c.setIntervalometerMode";
            ...
            public static final String GET_INTERVALOMETER_MODE = "c.getIntervalometerMode";
            public static final String GET_AVOID_OFFSET        = "c.getAvoidOffset";
        ...
        public static class KeyFrame {
            ...
            public static final String TAKE_UP_BACKLASH  = "k.takeUpBacklash";
            ...
            public static final String GET_CONT_VID_TIME = "k.getContVidTime";
    ...
    /**
     * Possible data lengths to be appended to a command: NULL, BYTE, INT, LONG,
     * FLOAT
     * 
     * @author Michael
     *
     ...
     * 
     * @param type
     *            Command type, see {@link Type}
     * @param command
     *            Command number; must correspond to switch case number in NMX
     *            firmware.
     * @param returnType
     *            Class of the return value type
     * @param name
     *            Name of the command as a String
     * @param dataType
     *            Class of the data value type
     */
    ...
    private void init(Command.Type type, int command, Class<?> returnType, String name, Class<?> dataType) {
        ...
        this.dataType = dataType;
        this.dataLength = dataType == Byte.class ? 1
                : dataType == Integer.class ? 2 : dataType == Long.class || dataType == Float.class ? 4 : 0;
    ...
    private static void initCommands() {
        ...
        generalList.add(
                new Command(Command.Type.GENERAL, 15, Names.General.SET_ALT_OUT_B4_SHOT_DELAY_TIME, Integer.class));
        generalList.add(
                new Command(Command.Type.GENERAL, 16, Names.General.SET_ALT_OUT_AFTER_SHOT_DELAY_TIME, Integer.class));
        generalList.add(new Command(Command.Type.GENERAL, 17, Names.General.SET_ALT_OUT_B4_SHOT_TIME, Integer.class));
        generalList
                .add(new Command(Command.Type.GENERAL, 18, Names.General.SET_ALT_OUT_AFTER_SHOT_TIME, Integer.class));
        ...
        generalList.add(new Command(Command.Type.GENERAL, 30, Names.General.SET_LOAD_POS, Byte.class));
        generalList.add(new Command(Command.Type.GENERAL, 31, Names.General.SET_LOAD_START_STOP, Byte.class));
        generalList.add(new Command(Command.Type.GENERAL, 32, Names.General.SET_LOAD_END, Byte.class));
        ...
        // Command 106 deprecated in firmware version 0.70
        ...
        generalList.add(
                new Command(Command.Type.GENERAL, 112, Integer.class, Names.General.GET_ALT_OUT_B4_SHOT_DELAY_TIME));
        generalList.add(
                new Command(Command.Type.GENERAL, 113, Integer.class, Names.General.GET_ALT_OUT_AFTER_SHOT_DELAY_TIME));
        generalList.add(new Command(Command.Type.GENERAL, 114, Integer.class, Names.General.GET_ALT_OUT_B4_SHOT_TIME));
        generalList
                .add(new Command(Command.Type.GENERAL, 115, Integer.class, Names.General.GET_ALT_OUT_AFTER_SHOT_TIME));
        ...
        generalList.add(new Command(Command.Type.GENERAL, 131, Boolean.class, Names.General.GET_LOAD_POS));
        ...
        motorList.add(new Command(Command.Type.MOTOR, 120, Integer.class, Names.Motor.IS_LEGACY_VALID));
        motorList.add(new Command(Command.Type.MOTOR, 121, Integer.class, Names.Motor.GET_UNITS));
        /*
         * The get gearbox and platform ratio commands must be divided by 1e6,
         * not the standard float conversion of 100. The larger conversion
         * factor is used to retain more decimal places.
         */
        ...
        keyFrameList
                .add(new Command(Command.Type.KEYFRAME, 11, Integer.class, Names.KeyFrame.SET_COUNT, Integer.class));
        ...
        keyFrameList.add(
                new Command(Command.Type.KEYFRAME, 15, Integer.class, Names.KeyFrame.SET_UPDATE_RATE, Integer.class));
        keyFrameList.add(new Command(Command.Type.KEYFRAME, 16, Names.KeyFrame.END_TRANSMISSION));
        keyFrameList.add(
                new Command(Command.Type.KEYFRAME, 17, Integer.class, Names.KeyFrame.SET_CONT_VID_TIME, Long.class));
        ...
        keyFrameList.add(new Command(Command.Type.KEYFRAME, 23, Names.KeyFrame.TAKE_UP_BACKLASH));
        ...
        keyFrameList
                .add(new Command(Command.Type.KEYFRAME, 104, Float.class, Names.KeyFrame.GET_ACCEL_AT, Float.class));
        ...
        keyFrameList.add(new Command(Command.Type.KEYFRAME, 107, Integer.class, Names.KeyFrame.GET_CONT_VID_TIME));

        keyFrameList.add(new Command(Command.Type.KEYFRAME, 120, Integer.class, Names.KeyFrame.GET_RUN_STATE));
        keyFrameList.add(new Command(Command.Type.KEYFRAME, 121, Integer.class, Names.KeyFrame.GET_RUN_TIME));
        keyFrameList.add(new Command(Command.Type.KEYFRAME, 122, Integer.class, Names.KeyFrame.GET_MAX_RUN_TIME));
        keyFrameList.add(new Command(Command.Type.KEYFRAME, 123, Integer.class, Names.KeyFrame.GET_PCT_DONE));
        keyFrameList.add(
                new Command(Command.Type.KEYFRAME, 130, Integer.class, Names.KeyFrame.GET_KF_ABSCISSA, Integer.class));
        keyFrameList
                .add(new Command(Command.Type.KEYFRAME, 131, Integer.class, Names.KeyFrame.GET_KF_POS, Integer.class));
        keyFrameList
                .add(new Command(Command.Type.KEYFRAME, 132, Float.class, Names.KeyFrame.GET_KF_VEL, Integer.class));
    }
    ...
    private <T> T executeThis(int subAddr, String dataStr, boolean hasData) {
        ...
        // Notify if data is attached to a command that does not take additional
        // data
        if (dataLength == 0 && hasData) {
            System.out.println("This command does not send additional data");
            this.printInfo();
        ...
        if (returnType == Integer.class) {
            ...
            if (this.getName().equals(Motor.GET_GBOX_RATIO) || this.getName().equals(Motor.GET_PLAT_RATIO)
                    || this.getName().equals(Motor.SET_GBOX_RATIO) || this.getName().equals(Motor.SET_PLAT_RATIO))
                conversionVal = 1e6f;
            else
        ...
        if (ret != null)
            System.out.println("Response val: " + ret);
        else
            System.out.println("OK!");
    ...
    public static void commandWait(int time) {
        while (NMXComs.isBusy()) {
            // Wait till the NMX communications class is free again before
            // proceeding
            try {
                Thread.sleep(time);
            } catch (InterruptedException e) {
